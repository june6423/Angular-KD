...
# CFG.REVIEWKD.SHAPES =  [1,8,16,32] # resnet32*4 -> resnet8*4
# CFG.REVIEWKD.OUT_SHAPES = [1,8,16,32]
# CFG.REVIEWKD.IN_CHANNELS = [64, 128, 256, 256]
# CFG.REVIEWKD.OUT_CHANNELS = [64, 128, 256, 256]

# CFG.REVIEWKD.SHAPES =  [1,4,4,8,16] # vgg13 -> vgg8
# CFG.REVIEWKD.OUT_SHAPES = [1,4,4,8,16]
# CFG.REVIEWKD.IN_CHANNELS = [128,256,512,512,512] 
# CFG.REVIEWKD.OUT_CHANNELS =  [128,256,512,512,512]

# CFG.REVIEWKD.SHAPES = [1,8,16,32] # wrn_40_2 -> wrn_40_1
# CFG.REVIEWKD.OUT_SHAPES = [1,8,16,32]
# CFG.REVIEWKD.IN_CHANNELS = [16,32,64,64]  
# CFG.REVIEWKD.OUT_CHANNELS =  [32,64,128,128]

CFG.REVIEWKD.SHAPES = [1,8,16,32] # resnet32*4 -> wrn_40_2 / wrn_16_2
CFG.REVIEWKD.OUT_SHAPES =  [1,8,16,32] 
CFG.REVIEWKD.IN_CHANNELS =  [32,64,128,128] 
CFG.REVIEWKD.OUT_CHANNELS =  [64, 128, 256, 256] 

# CFG.REVIEWKD.SHAPES = [1,8,16,32] #wrn_40_2 -> resnet8*4
# CFG.REVIEWKD.OUT_SHAPES =  [1,8,16,32] 
# CFG.REVIEWKD.IN_CHANNELS =  [64, 128, 256, 256] 
# CFG.REVIEWKD.OUT_CHANNELS =  [32,64,128,128] 
...
# DIV (Diverse Knowledge Distillation) CFG
CFG.DIV = CN()
CFG.DIV.USAGE = False
CFG.DIV.AUGNUM = 5
CFG.DIV.FEAT_INTERWEIGHT = 0.1
CFG.DIV.FEAT_INTRAWEIGHT = 1.0
CFG.DIV.LOGIT_INTERWEIGHT = 1.0
CFG.DIV.LOGIT_INTRAWEIGHT = 1.0
CFG.DIV.DKD = False
CFG.DIV.MLKD = False
...
CFG.TEKAP = CN()
CFG.TEKAP.USAGE = False
CFG.TEKAP.FEAT = True
CFG.TEKAP.LOGIT = True
CFG.TEKAP.AUGNUM = 3
CFG.TEKAP.T = 4
CFG.TEKAP.DKD = False
CFG.TEKAP.MLKD = False
